export default function CreditCardPreview({ cardDetails, isFlipped }) {
    return (
        <div className={`hidden md:block ml-[7%] w-full md:w-1/2 max-w-md transform transition-all duration-700 perspective-1000 ${isFlipped ? 'rotate-y-180' : ''}`}>
        <div className="w-full min-h-[220px] bg-gradient-to-br from-[#064c4f] via-[#0a5c60] to-[#045d61] shadow-2xl rounded-[22px] m-0 p-8 flex flex-col justify-around gap-5 backdrop-blur-lg relative overflow-hidden">
